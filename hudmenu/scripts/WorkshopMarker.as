package
{
   ...
   public class WorkshopMarker extends MovieClip
   {
      ...
      private function AdjustPosition(param1:Boolean) : void
      {
         ...
         var _loc4_:Number = this.x - _loc2_ / 2;
         if(_loc4_ < 0)
         {
            this.x -= _loc4_;
         }
         ...
         {
            _loc6_ = this.x + _loc2_ / 2 - Extensions.visibleRect.right;
            if(_loc6_ > 0)
            {
               this.x -= _loc6_;
            }
         }
         var _loc5_:Number = this.y - _loc3_ / 2;
         if(_loc5_ < 0)
         {
            this.y -= _loc5_;
         }
         ...
         {
            _loc7_ = this.y + _loc3_ / 2 - Extensions.visibleRect.bottom;
            if(_loc7_ > 0)
            {
               this.y -= _loc7_;
            }
